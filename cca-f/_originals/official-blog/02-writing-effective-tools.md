...
[Image: Code snippet depicting a detailed tool response]

Here's an example of a concise tool response (72 tokens):

[Image: Code snippet depicting a concise tool response]
...
[Image: Example of a truncated tool response]

Here's an example of an unhelpful error response:

[Image: Example of an unhelpful tool response]

Here's an example of a helpful error response:

[Image: Example of a helpful error response]
