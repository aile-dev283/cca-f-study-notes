...
> 公式 Exam Guide PDF（`CCA-F_Certification_Exam_Guide.pdf`）を Markdown 化したもの。
> Version 0.1 / Last Updated: Feb 10 2025 / Anthropic, PBC · Confidential Need to Know (NTK)
...
以下のサンプル問題は試験の形式と難易度を示すもの。Practice Test から抜粋され、学習用に解説が付されている。
...
各演習は1つ以上の試験ドメインを横断して知識を補強するように設計されている。
