...
Lesson reflection
Think about your most recent interactions with Claude Code. Which instructions did you find yourself repeating? How might a

---

### レッスン 02: Creating your first skill
...
How might the priority hierarchy affect your te

---

### レッスン 03: Configuration and multi-file skills
...
Scripts in your skill directory can run without loading their contents into context. The script executes and only the output consumes tokens. The key instructi

---

### レッスン 04: Skills vs. other Claude Code features
...
You want isolated task delegation with specific ex

---

### レッスン 06: Troubleshooting skills
